...
const generateInvoicePDF = (sale, filePath) => {
  return new Promise((resolve, reject) => {
    try {
      ...
      const businessName = process.env.STORE_NAME || 'MAHALAXMI SHETI SEVA KENDRA HASUR KHURD';
      const businessEmail = process.env.STORE_EMAIL || 'mahalxmiShetiSevaKendra@gmail.com';
      const businessPhone = process.env.STORE_PHONE || '7820974939';
      const businessGst = process.env.STORE_GST || '27XXXXX1234X1ZX';
      const businessAddress = process.env.STORE_ADDRESS || 'Hasur Khurd, Tal. Kagal, Dist. Kolhapur, Maharashtra - 416216';
  ...
  return new Promise((resolve, reject) => {
    try {
      ...
      doc.fillColor('#444444')
        .fontSize(20)
        .text('KRUSHISTOCK INVENTORY', 50, 45)
        .fontSize(10)
      ...
      doc.fontSize(10)
        .fillColor('#777777')
        .text('Purchase invoice generated by KrushiStock.', 50, 720, { align: 'center', width: 500 });
