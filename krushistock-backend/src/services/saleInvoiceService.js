...
const buildSaleInvoicePayload = (sale) => {
  ...
  return {
    ...
    business: {
      name: process.env.STORE_NAME || 'Mahalaxmi Sheti Seva Kendra Hasur Khurd',
      tagline: 'Agriculture Stock & Billing Solutions',
      email: process.env.STORE_EMAIL || 'mahalxmiShetiSevaKendra@gmail.com',
      phone: process.env.STORE_PHONE || '9921868020',
      gst: process.env.STORE_GST || '27AABCK1234F1Z5',
      address: process.env.STORE_ADDRESS || ' Hasur Khurd ,Maharashtra, India'
    },
    ...
    footer: {
      note: 'Thank you for choosing Mahalaxmi Sheti Seva Kendra.',
      support: process.env.STORE_EMAIL || 'info@krushistock.com',
